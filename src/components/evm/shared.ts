 ...
 * instead of collapsing them to "$0.00" — Base gas fees are routinely a
 * fraction of a cent (a real $0.003 fee otherwise displays as "$0.00" and
 * looks like a bug/unpopulated field, which it isn't).
 */
