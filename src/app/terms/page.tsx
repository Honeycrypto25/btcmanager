export const metadata = { title: "Terms of Use — Personal Dashboard" };
    ...
    return (
        <main style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px", lineHeight: 1.6, color: "#e5e5e0", background: "#0a0a09" }}>
            ...
            <p style={{ marginBottom: 16 }}>
                Personal Dashboard is a private, single-user application built and operated by its account holder for
